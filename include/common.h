...
#define PTX(PTX_n)  (PTX_n>>5)  //Obtener el número de módulo PTX_n/32
#define PTn(PTX_n)  (PTX_n&0x1f)//Número de pierna de negociación PTX_n%32
